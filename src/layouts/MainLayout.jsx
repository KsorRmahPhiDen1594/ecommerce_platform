...
//                   <img  alt="Visa" className="h-7" src="https://images.unsplash.com/photo-1585915473635-d4e5c564eec3" />
//                   <img  alt="Mastercard" className="h-7" src="https://images.unsplash.com/photo-1608286022625-bc07f7a21154" />
//                   <img  alt="JCB" className="h-7" src="https://images.unsplash.com/photo-1611416811039-e326d73a68d3" />
//                   <img  alt="American Express" className="h-7" src="https://images.unsplash.com/photo-1649251855096-f8beda8f6b24" />
//                   <img  alt="COD" className="h-7" src="https://images.unsplash.com/photo-1687199127283-2bb87b8a92fc" />
//                   <img  alt="ShopeePay" className="h-7" src="https://images.unsplash.com/photo-1586880244543-0528a802be97" />
//                   <img  alt="ZaloPay" className="h-7" src="https://images.unsplash.com/photo-1631005551113-6533834aefea" />
//                   <img  alt="Momo" className="h-7" src="https://images.unsplash.com/photo-1556742208-999815fca738" />
//                 </div>
//                 <span className="text-md font-semibold text-gray-800 dark:text-white block mb-3 mt-4">Đơn vị vận chuyển</span>
//                  <div className="flex flex-wrap gap-2 items-center">
//                   <img  alt="Shopee Express" className="h-7" src="https://images.unsplash.com/photo-1703489583404-4ee76c06482b" />
//                   <img  alt="GHTK" className="h-7" src="https://images.unsplash.com/photo-1666291631431-85cd843669ee" />
//                   <img  alt="GHN" className="h-7" src="https://images.unsplash.com/photo-1591370017352-3014ad5b8055" />
//                   <img  alt="Viettel Post" className="h-7" src="https://images.unsplash.com/photo-1597658847720-47d08e01e63c" />
//                 </div>
//               </div>
//               <div>
...
//                   <img  alt="QR Code for app download" className="h-20 w-20 border p-0.5 rounded" src="https://images.unsplash.com/photo-1626682561113-d1db402cc866" />
//                   <div className="flex flex-col space-y-1">
//                     <a href="#" target="_blank" rel="noopener noreferrer"><img  alt="Download on App Store" className="h-10" src="https://images.unsplash.com/photo-1587573578335-9672da4d0292" /></a>
//                     <a href="#" target="_blank" rel="noopener noreferrer"><img  alt="Get it on Google Play" className="h-10" src="https://images.unsplash.com/photo-1648134859182-98df6e93ef58" /></a>
//                     <a href="#" target="_blank" rel="noopener noreferrer"><img  alt="Explore it on AppGallery" className="h-10" src="https://images.unsplash.com/photo-1583268921016-514d0a038478" /></a>
//                   </div>
//                 </div>
//               </div>
//             </div>
...
const MainLayout = () => {
  ...
  const createSlug = (text) => {
    ...
    return text
      ...
      .replace(/đ/g, 'd').replace(/Đ/g, 'd')  // Xử lý đ/Đ
  ...
  const categories = ['Điện thoại', 'Laptop', 'Thời trang nam', 'Thời trang nữ', 'Đồ gia dụng', 'Sức khỏe & Sắc đẹp'];
            ...
            <div className="flex items-center space-x-4">
              ...
              {currentUser ? (
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="ghost" className="flex items-center space-x-2 px-2 py-1">
                      <img src={`https://api.dicebear.com/7.x/initials/svg?seed=${currentUser.name}`} alt="avatar" className="h-8 w-8 rounded-full border border-primary" />
