    ...
    <div className='min-h-screen text-[#3c1e1e] overflow-hidden'>
      ...
      <section className='max-w-4xl px-6 py-10 mx-auto'>
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h3 className='mb-6 text-xl font-semibold text-center'>Quy trình tiếp nhận phản hồi</h3>
          <ul className='space-y-4 text-sm text-gray-700'>
            ...
            <li className='flex items-start gap-3'>
              <Coffee className='text-[#a72626] mt-1' />
              <span>
                <strong>2.</strong> Đội ngũ của chúng tôi tiếp nhận và đánh giá thông tin.
              </span>
            </li>
            <li className='flex items-start gap-3'>
              <Coffee className='text-[#a72626] mt-1' />
              <span>
                <strong>3.</strong> Highlands điều chỉnh và cải thiện dịch vụ nếu cần thiết.
              </span>
            </li>
          </ul>
        </motion.div>
      ...
      <section className='max-w-3xl px-6 py-16 mx-auto'>
        ...
        >
          ...
          <div>
            <label className='block mb-2 text-sm font-semibold'>Đánh giá trải nghiệm</label>
          ...
          <div>
            <label className='block mb-2 text-sm font-semibold'>Nội dung góp ý</label>
            <textarea
