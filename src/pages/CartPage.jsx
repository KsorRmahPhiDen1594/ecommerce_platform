    ...
    <div className='container mx-auto'>
      ...
      {cartItems.length === 0 ? (
        ...
        >
          ...
          <p className='mb-4 text-xl text-muted-foreground'>Giỏ hàng của bạn đang trống trơn.</p>
          <p className='mb-6 text-sm text-muted-foreground'>
            Hãy khám phá thêm nhiều sản phẩm tuyệt vời nhé!
          </p>
          <Button asChild className='px-8 py-3 gradient-highlands text-primary-foreground text-md'>
          ...
          >
            ...
            <Card className='shadow-lg'>
              ...
              <CardContent className='flex p-4 space-x-2'>
                <Input placeholder='Nhập mã giảm giá ShopeeCharm' className='text-sm h-9' />
