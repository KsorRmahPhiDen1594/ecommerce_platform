  ...
  return (
    <div className='container py-8 mx-auto md:py-12'>
      ...
      >
        ...
        <h1 className='mb-3 text-4xl font-bold text-amber-800 md:text-5xl'>Về Highlands Coffee</h1>
        <p className='max-w-2xl mx-auto text-lg md:text-xl text-muted-foreground'>
          Highlands Coffee – thương hiệu cà phê Việt được xây dựng với niềm tự hào dân tộc, mang đến
          hương vị cà phê đậm đà và không gian sẻ chia ấm áp.
        </p>
      </motion.section>
              ...
              >
                ...
                <div className='w-full space-y-4 md:w-1/2'>
                  <div className='flex items-center gap-3'>
                    ...
                    <h3 className='text-xl font-semibold text-amber-800'>{value.title}</h3>
                  </div>
                  <p className='leading-relaxed text-gray-700 text-md'>{value.description}</p>
                </div>
              </motion.div>
            );
          })}
