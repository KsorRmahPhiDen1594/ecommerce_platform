...
const policies = [
  {
    ...
    description: (
      <>
        ...
        <span className="font-semibold">24 giờ</span> kể từ khi nhận hàng đối
        với các trường hợp:
  ...
  },
  {
    ...
    description: (
      <>
        Chúng tôi cam kết bảo mật tuyệt đối thông tin cá nhân của khách hàng. Dữ
        liệu chỉ được sử dụng cho mục đích:
        <ul className="mt-3 space-y-1 text-gray-700 list-disc list-inside">
  ...
  },
  {
    ...
    description: (
      <>
        Đối với các sản phẩm phụ kiện, Highlands Coffee áp dụng chính sách bảo
        hành trong vòng <span className="font-semibold">7 ngày</span> kể từ khi
