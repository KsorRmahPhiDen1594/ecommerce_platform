            ...
            <CardContent>
              <div className='h-72 md:h-80 bg-muted/50 dark:bg-slate-800/50 rounded flex items-center justify-center p-4'>
                ...
                <span className='ml-4 text-muted-foreground'>
                  Dữ liệu biểu đồ sẽ được hiển thị ở đây. (Cần thư viện biểu đồ)
                </span>
              </div>
            </CardContent>
          </Card>
              ...
              {[
                ...
                <div key={cat} className='flex justify-between items-center text-sm'>
                  ...
                  <Badge variant='secondary' className='font-mono'>
                    {Math.floor(Math.random() * 500 + 50)} đơn
                  </Badge>
                </div>
              ))}
            </CardContent>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8'>
          ...
          <Card className='shadow-lg'>
            ...
            <CardContent className='space-y-2 text-sm'>
              <div className='flex justify-between'>
                <span>Đang xử lý:</span> <span className='font-semibold'>50</span>
              </div>
              <div className='flex justify-between'>
                <span>Đang giao:</span> <span className='font-semibold'>75</span>
              </div>
              <div className='flex justify-between'>
                <span>Hoàn thành:</span> <span className='font-semibold'>1230</span>
              </div>
              <div className='flex justify-between'>
                <span>Đã hủy:</span> <span className='font-semibold'>15</span>
              </div>
            </CardContent>
          </Card>
        </motion.div>
        ...
        >
          <Card className='shadow-lg'>
            ...
            <CardContent className='space-y-2 text-sm'>
              <div className='flex justify-between'>
                <span>Đang hoạt động:</span> <span className='font-semibold'>1,205</span>
              </div>
              <div className='flex justify-between'>
                <span>Đăng ký mới (24h):</span> <span className='font-semibold'>88</span>
              </div>
              <div className='flex justify-between'>
                <span>Tổng số người dùng:</span> <span className='font-semibold'>15,670</span>
              </div>
            </CardContent>
          </Card>
        </motion.div>
        ...
        >
          <Card className='shadow-lg'>
            ...
            <CardContent className='space-y-2 text-sm'>
              ...
              <div className='flex justify-between'>
                <span>Lỗi gần đây:</span> <span className='font-semibold'>0</span>
              </div>
              <div className='flex justify-between'>
                <span>Lần bảo trì cuối:</span> <span className='font-semibold'>20/05/2025</span>
              </div>
            </CardContent>
          </Card>
        </motion.div>
