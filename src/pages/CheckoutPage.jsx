    ...
    return (
      ...
      >
        ...
        <p className='mb-6 text-muted-foreground'>
          Cảm ơn bạn đã tin tưởng và mua sắm tại ShopeeCharm. Đơn hàng của bạn đang được xử lý.
        </p>
      ...
      <div className='grid grid-cols-1 gap-6 lg:grid-cols-3 md:gap-8'>
        ...
        >
          <Card className='shadow-md'>
            <CardHeader className='p-4 border-b'>
              <CardTitle className='flex items-center text-lg'>
                <Truck className='w-5 h-5 mr-2 text-primary' /> Địa chỉ giao hàng
              </CardTitle>
            </CardHeader>
          ...
          <Card className='shadow-md'>
            <CardHeader className='p-4 border-b'>
              <CardTitle className='flex items-center text-lg'>
                <DollarSign className='w-5 h-5 mr-2 text-primary' /> Phương thức thanh toán
              </CardTitle>
            </CardHeader>
            <CardContent className='p-4'>
              <RadioGroup defaultValue='cod' value={paymentMethod} onValueChange={setPaymentMethod}>
                ...
                <div className='flex items-center p-3 space-x-2 transition-colors border rounded-md hover:border-primary'>
                  ...
                  <Label htmlFor='zalopay' className='flex-grow cursor-pointer'>
                    Ví ZaloPay
                  </Label>
                  <img
                    alt='ZaloPay'
                ...
                <div className='flex items-center p-3 space-x-2 transition-colors border rounded-md hover:border-primary'>
                  ...
                  <Label htmlFor='shopeepay' className='flex-grow cursor-pointer'>
                    Ví ShopeeCharmPay
                  </Label>
                  <img
                    alt='ShopeeCharmPay'
        ...
        >
          <Card className='sticky shadow-lg glassmorphism top-24'>
            <CardHeader className='p-4 border-b'>
              <CardTitle className='flex items-center text-lg'>
                <Gift className='w-5 h-5 mr-2 text-primary' /> Đơn hàng của bạn
              </CardTitle>
            </CardHeader>
